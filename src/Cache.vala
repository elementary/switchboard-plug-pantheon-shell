...
public class Cache {
    ...
    public static string? get_thumbnail (string uri, uint? size = null) {
        string[] sizes;
        if (size == null) {
            sizes = { "large", "normal" };
    ...
    public static string? try_get_thumbnail (string uri, string size) {
    ...
    private static bool is_thumbnail_valid (string uri, string thumb_path, long mtime) {
    ...
    private static string build_thumbnail_path (string uri, string size) {
